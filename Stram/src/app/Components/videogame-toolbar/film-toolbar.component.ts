...
@Component({
  ...
  templateUrl: './film-toolbar.component.html',
  styleUrl: './film-toolbar.component.css'
})
export class FilmToolbarComponent implements OnInit {
  ...
  constructor(private VideogameManagerService : FilmDataService, private router : Router, private UserListService : UserListsService){ }
