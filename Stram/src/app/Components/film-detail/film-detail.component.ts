...
import { genere, film } from '../../model/Film';
...
export class FilmDetailComponent implements OnInit{
  ...
  constructor(private videogameData: FilmDataService, private route : ActivatedRoute, private generalTasks : GeneralTasksService, private router : Router) {}
  ...
  HandleUpdateData(){
    ...
    (Number.isNaN(anno) || anno >= 2050 || anno <= 1950 ) ? this.videogame.anno= 9999 : this.videogame.anno=anno;
